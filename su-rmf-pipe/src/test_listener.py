...
def test_init_socket(init_listener):
    """
    Tests that init_socket runs without problems
    """
    sock = init_listener.init_socket()
    assert sock == init_listener.sock


def test_init_socket_already_bound(init_listener):
    """
    sock.listen can raise an exception (how?)
    https://stackoverflow.com/questions/42182020/write-a-unit-test-with-pytest-to-test-a-socket
    """